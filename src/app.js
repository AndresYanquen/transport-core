...
const adminSecurityRoutes = require("./modules/admin-security/routes/admin-security.routes");
...
const whatsappWebhookRoutes = require("./modules/whatsapp/routes/kapso-whatsapp.routes");
...
app.use("/api/admin/security", authenticate, adminSecurityRoutes);
